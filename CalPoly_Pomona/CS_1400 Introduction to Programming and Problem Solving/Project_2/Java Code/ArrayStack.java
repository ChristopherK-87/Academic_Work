public class ArrayStack{
     ...
     * 
     * If the stack is empty, then an exception will be thrown. Else top element is assigned to a local variable and returned, and the
     *    index of the stack array is decremented.
     * 
     * @exception: EmptyStackException  If the stack is empty before attemping the pop operation, then the execption will be thrown.
     * @Param:     NONE
     * @Return:    topElement           Local variable assigned the value of the top element of the stack.
     */
    public int pop(){
        if( isEmpty() )
    ...
    /**
     * Method designed to view the top element of a stack array without removal from the stack.
     * 
     * If the stack is empty, then an exception will be thrown. Else top element is returned using a local variable.
     * 
     * @exception: EmptyStackException  If the stack is empty before attemping the peek operation, then the execption will be thrown.
     * @Param:     NONE
     * @Return:    lastElement          Local variable assigned the value of the top element of the stack.
     */
    public int peek(){
        if( isEmpty() )
            throw new EmptyStackException();
    ...
    /**
     * Method designed to loop through the stack array and assign a value of zero to each index of the stack array. The method 
     *     also assigns the value of zero to the fields currentPosition and count.
     * 
     * @exception: EmptyStackException  If the stack is empty before attemping the clear operation, then the execption will be thrown.
     * @Param:     NONE
     * @Return:    N/A
     */
    public void clear(){
     ...
     */
    private int[] copyArray(int[] oldStore, int newSize){
